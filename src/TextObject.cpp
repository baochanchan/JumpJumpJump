...
TextObject::TextObject()//ctor//khoi tao gtri da
{
    text_color.r = 255;
    text_color.g = 255;
    text_color.b = 255;
...
bool TextObject::LoadFromRenderText(TTF_Font* font, SDL_Renderer* screen)//load text len tao surface, dua texture len man hinh
{
...
void TextObject::RenderText(SDL_Renderer* screen, int xp, int yp, SDL_Rect* clip, double angle, SDL_Point* center, SDL_RendererFlip flip)
{
    ...
    SDL_RenderCopyEx(screen, texture, clip, &renderQuad, angle, center, flip);//truyen vao
}
